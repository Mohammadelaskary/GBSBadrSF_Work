...
public class qualityrepairAdapter extends RecyclerView.Adapter<qualityrepairAdapter.qualityrepairViewHolder> {
    ...
    @NonNull
    @Override
    public qualityrepairViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new qualityrepairViewHolder(defectlistinqualityrepairBinding);
    }

    @Override
    public void onBindViewHolder(@NonNull qualityrepairViewHolder holder, int position) {
        if (position==0){
