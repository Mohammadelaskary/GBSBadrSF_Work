...
public final class FragmentAddworkersBinding implements ViewBinding {
  ...
  public static FragmentAddworkersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView addworkerTxt = ViewBindings.findChildViewById(rootView, id);
      if (addworkerTxt == null) {
        break missingId;
      }

      id = R.id.elro5sa_txt;
      CheckBox elro5saTxt = ViewBindings.findChildViewById(rootView, id);
      if (elro5saTxt == null) {
        break missingId;
      }

      id = R.id.exportid_checkBox;
      CheckBox exportidCheckBox = ViewBindings.findChildViewById(rootView, id);
      if (exportidCheckBox == null) {
        break missingId;
      }

      id = R.id.markazelba7oth;
      CheckBox markazelba7oth = ViewBindings.findChildViewById(rootView, id);
      if (markazelba7oth == null) {
        break missingId;
      }

      id = R.id.savecustexa_btn;
      MaterialButton savecustexaBtn = ViewBindings.findChildViewById(rootView, id);
      if (savecustexaBtn == null) {
        break missingId;
      }

      id = R.id.shadatelmansha_txt;
      CheckBox shadatelmanshaTxt = ViewBindings.findChildViewById(rootView, id);
      if (shadatelmanshaTxt == null) {
        break missingId;
      }

      id = R.id.workername_txt;
      TextView workernameTxt = ViewBindings.findChildViewById(rootView, id);
