...
public final class FragmentProductionMenuBinding implements ViewBinding {
  ...
  private FragmentProductionMenuBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView productionmenuTxt, @NonNull MaterialButton weldingBtn) {
  ...
  public static FragmentProductionMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MaterialButton ManfacturingBtn = rootView.findViewById(id);
      if (ManfacturingBtn == null) {
        break missingId;
      }

      id = R.id.Paint_btn;
      MaterialButton PaintBtn = rootView.findViewById(id);
      if (PaintBtn == null) {
        break missingId;
      }

      id = R.id.productionmenu_txt;
      TextView productionmenuTxt = rootView.findViewById(id);
      if (productionmenuTxt == null) {
        break missingId;
      }

      id = R.id.welding_btn;
      MaterialButton weldingBtn = rootView.findViewById(id);
      if (weldingBtn == null) {
        break missingId;
      }

      return new FragmentProductionMenuBinding((ConstraintLayout) rootView, ManfacturingBtn,
          PaintBtn, productionmenuTxt, weldingBtn);
    }
