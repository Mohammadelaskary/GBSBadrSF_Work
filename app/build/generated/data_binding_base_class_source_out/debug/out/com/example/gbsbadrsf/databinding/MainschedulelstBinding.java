...
public final class MainschedulelstBinding implements ViewBinding {
  ...
  public static MainschedulelstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView jobordreqtnTxt = rootView.findViewById(id);
      ...
      id = R.id.nextoper;
      TextView nextoper = rootView.findViewById(id);
      if (nextoper == null) {
        break missingId;
      }

      id = R.id.nextoper_txt;
      TextView nextoperTxt = rootView.findViewById(id);
      if (nextoperTxt == null) {
        break missingId;
      }

      id = R.id.sequence_num;
      TextView sequenceNum = rootView.findViewById(id);
      if (sequenceNum == null) {
        break missingId;
      }

      id = R.id.sequence_txt;
      TextView sequenceTxt = rootView.findViewById(id);
      if (sequenceTxt == null) {
        break missingId;
      }
